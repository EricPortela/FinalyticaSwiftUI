...
class HomePageModel: ObservableObject {
    ...
    private func getIndicies() {
        guard let url = URL(string: "https://financialmodelingprep.com/api/v3/quotes/index?apikey=81b0fcbc66a84fde19d92e64f2846956") else {return}
    ...
    private func getFavoritesData() {
        guard let url = URL(string:         "https://financialmodelingprep.com/api/v3/quote/AAPL,META,GOOG?apikey=81b0fcbc66a84fde19d92e64f2846956") else {return}
    ...
    public func getDailyHistoricalPricesIndex(indexTicker: String) -> Void {
        guard let url = URL(string: "https://financialmodelingprep.com/api/v3/historical-price-full/%5E\(indexTicker)?apikey=81b0fcbc66a84fde19d92e64f2846956") else {return}
